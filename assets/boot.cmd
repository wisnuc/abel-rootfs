if test -e ${devtype} ${devnum} ${prefix}alt; then
  ...
  echo "Boot from ${devtype} ${devnum}:${partnum}, rootfs b"
else
  setenv partnum 2
  setenv rootdev "UUID=689b853f-3749-4055-8359-054bd6e806b4"
  echo "Boot from ${devtype} ${devnum}:${partnum}, rootfs a"
fi

setenv bootargs "root=${rootdev} rootwait rootfstype=ext4 console=tty0 console=ttyS2,1500000"
